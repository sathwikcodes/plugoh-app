...
/**
 * Minimal earnings shape the home screen renders. The influencer tab passes its
 * full `EarningsSummary` (a superset) directly; the brand tab passes a derived
 * object with the same four fields.
 */
...
function HomeTierHero({ earnings, loading }: { earnings?: HomeEarnings; loading: boolean }) {
...
function routeToCampaignOrList(campaigns: CampaignListItem[], campaignsListRoute: Href) {
  ...
  router.push(campaignsListRoute);
}
...
function DeliveryFocusCard({
  ...
  return (
    <Pressable
      onPress={() => {
        routeToCampaignOrList(sortedDeliveryCampaigns, campaignsListRoute);
      }}
...
function PendingEarningsFocusCard({
  ...
  return (
    <Pressable
      onPress={() => {
        routeToCampaignOrList(pendingCampaigns, campaignsListRoute);
      }}
      accessibilityRole="button"
  ...
  return (
    <View style={insightStyles.section}>
      <View style={insightStyles.insightStack}>
        ...
        <TierProgressFocusCard earnings={earnings} loading={loading} profileRoute={profileRoute} />
      </View>
    </View>
  );
}
...
export type HomeScreenProps = {
  earnings: HomeEarnings | undefined;
  campaigns: CampaignListItem[];
  heroLoading: boolean;
...
/**
 * Shared home composition for both roles. The influencer and business tabs
 * fetch their own profile/earnings/campaigns and pass the resolved values in;
 * the only role differences are the profile + campaigns-list routes.
 */
export function HomeScreen({
  ...
  return (
    ...
    >
      <HomeTierHero earnings={earnings} loading={heroLoading} />
